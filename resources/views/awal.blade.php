  ...
  <div class="row">
    <div class="col-md-8 col-md-offset-2">
      <div class="panel panel-default">
        <div class="panel-heading">Sistem Informasi Inventaris PT PLN (persero) </div>
        <div class="panel-body">

                
<a href="{{ url('/register') }}" class="btn btn-default btn-lg btn-block">Register</a>
<a href="{{ url('/auth/login') }}" class="btn btn-primary btn-lg btn-block">Login</a>
