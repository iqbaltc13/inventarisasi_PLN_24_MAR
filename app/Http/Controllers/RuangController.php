...
class RuangController extends Controller
{
    ...
    public function create()
    {
        //
         if (Request::isMethod('get')) {
            ...
            return redirect()->action('AreaController@detail', [$data['fid_area']]);
        }
    }
    ...
    public function update($id_ruang)
    {
        ...
        if($item->gambar!=NULL){
            ...
            return redirect()->action('AreaController@detail', [Input::get('fid_area')]);
        }
    }
  ...
  alert()->error('','Ruangan tidak dapat dihapus! Silahkan hapus terlebih dahulu barang yang berhubungan dengan ruangan ini.')->persistent('Close');
        return back()->WithInput();
